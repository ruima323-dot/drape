...
- [x] 1. Set up project structure, tooling, and shared types
  - [x] 1.1 Initialize monorepo with frontend (React + Tailwind CSS + Vite) and backend (Node.js + TypeScript) packages
...
- [x] 2. Implement database schema and data access layer
  - [x] 2.1 Create PostgreSQL migration scripts for all tables
  ...
  - [x] 2.2 Implement data access functions (repository layer)
...
- [x] 3. Implement Wardrobe Parser
  - [x] 3.1 Implement `parseWardrobe` function
  ...
  - [x] 3.2 Implement `parseAccessoryPrompt` function
  ...
  - [x] 3.3 Implement `formatWardrobeItem` and `formatAccessory` functions
...
- [x] 5. Implement Outfit Generator
  - [x] 5.1 Implement prompt builder
  ...
  - [x] 5.4 Implement AWS Bedrock integration for image generation
  ...
  - [x] 5.5 Implement S3 image storage integration
  ...
  - [x] 5.6 Wire `generateOutfit` end-to-end
...
- [x] 6. Implement Accessory Compositor
  - [x] 6.1 Implement `addAccessory` function
  ...
  - [x] 6.2 Implement `removeAccessory` function
  ...
  - [x] 6.3 Implement `toggleAccessory` function
...
- [x] 7. Checkpoint — Ensure compositor and generator tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Implement Recommendation Engine
  - [x] 8.1 Implement `suggestAccessories` function
...
- [x] 9. Implement REST API endpoints
  - [x] 9.1 Set up API server with authentication middleware
  ...
  - [x] 9.2 Implement wardrobe API endpoints
  ...
  - [x] 9.3 Implement outfit generation and saving API endpoints
  ...
  - [x] 9.4 Implement accessory API endpoints
  ...
  - [x] 9.5 Implement user profile API endpoints
...
- [x] 11. Implement frontend design system and layout
  - [x] 11.1 Configure Tailwind theme with Drape design tokens
  ...
  - [x] 11.2 Implement App Shell with routing and auth
...
- [x] 12. Implement My Wardrobe page
  - [x] 12.1 Build TextInput component for wardrobe entry
  ...
  - [x] 12.2 Build WardrobeGrid and WardrobeItemCard components
  ...
  - [x] 12.3 Build empty state for zero wardrobe items
...
- [x] 13. Implement Today's Look page — Outfit Generation
  - [x] 13.1 Build ContextToggle component
  ...
  - [x] 13.2 Build AvatarCard component
  ...
  - [x] 13.3 Build Avatar configuration UI
  ...
  - [x] 13.4 Build Style Questionnaire flow
...
- [x] 14. Implement Today's Look page — Accessory Features
  - [x] 14.1 Build AccessoryPromptInput component
  ...
  - [x] 14.2 Build AccessoryShelf component
  ...
  - [x] 14.3 Build SuggestionPanel component
...
- [x] 15. Implement Today's Look page — Save Outfit
  - [x] 15.1 Build SaveButton and save flow
...
- [x] 16. Checkpoint — Ensure Today's Look and Wardrobe pages work end-to-end
  - Ensure all tests pass, ask the user if questions arise.

- [x] 17. Implement Outfit Journey page
  - [x] 17.1 Build Timeline component with monthly grouping
  ...
  - [x] 17.2 Build FilterChips component
  ...
  - [x] 17.3 Build OutfitCard and OutfitDetailExpanded components
  ...
  - [x] 17.4 Build empty state for zero saved outfits
